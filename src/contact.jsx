        ...
        <>
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-3 col-sm-12 text-center">
                        ...
                        <div className="card cardBlur p-2">
                            ...
                            <br />
                            <Link style={{textAlign:"center"}} to="/"><small>Who doesn't like an offer?</small></Link>
                            </p>
                        </div>
                        <div className="mt-3">
                ...
                <div className="text-center card cardBlur p-3 mt-3">
                    <big>DREAM CITY CRICKET ACADMEY</big>
                    <br />
                ...
                <form className="card cardBlur p-5 mt-5"onSubmit={handleSubmit} noValidate>
                    <div className="mb-3">
                        <label for="textName" className="form-label">Full Name</label>
                    ...
                    <div className="mb-3">
                        <label for="textSubject" className="form-label">Subject</label>
                    ...
                    <div className="form-floating">
                        ...
                        <label for="floatingTextarea"><small>Tell us! What you think about DCCA?</small></label>
                    </div>
