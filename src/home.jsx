...
let Home = () => {
  ...
  return (
    <>
      <div className="container shadow p-5" id="shodowContainer">
        ...
        <div className="row">
          <div className="col-md-4 col-sm-12">
            <div className="p-3 mt-3 bg-light">
              <p className="text-muted">Want to join us? Click below button!</p>
                    ...
                    <div className="modal-body">
                      <div className="container">
                        <div className="col-12">
                          ...
                          >
                            <div>
                              <label for="textName" className="form-label">
                                Participant's Name
                              </label>
                              <input
                                name="name"
                            ...
                            <div>
                              <label for="textpName" className="form-label">
                                Parent's Name
                              </label>
                              <input
                                name="pname"
                            ...
                            <label for="realtion" className="form-label">
            ...
            <div className="mt-3">
              <p className="text-light">
                ...
                Nandurbar offers cricket
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;training
                throughout the year.&nbsp; DCCA &nbsp;&nbsp;&nbsp; offers
                bowling coaching,
                &nbsp;&nbsp;&nbsp;batting&nbsp;&nbsp;&nbsp;&nbsp;
                coaching,&nbsp;&nbsp;&nbsp; one on one coaching & more.
                <br />
                <br />
                Having a team of <b>6+</b> coaches and facilities which include
                cutting-edge &nbsp;&nbsp; technologies, analysis
                &nbsp;&nbsp;&nbsp;&nbsp;software for&nbsp;&nbsp;&nbsp; cricket
                coaching,&nbsp;&nbsp;&nbsp; DCCA also provides accommodation for
                out station trainees.
              </p>
            </div>
            <hr />
            <div className="mt-3">
              <h5 className="text-light">HOW TO ENROLL?</h5>
              <p className="text-center text-muted mt-3 bg-light p-3">
                STEPS FOR ENROLL!
              </p>
              <hr />
