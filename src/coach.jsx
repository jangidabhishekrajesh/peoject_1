                ...
                <div className="row">
                    ...
                    <div className="col-md-9 col-sm-12">
                        <div className="cardBlur mt-5 p-2">
                                ...
                                <ul style={{listStyleType:"none"}}>
                                    <li>1. Level-3 from MHCA</li>
                                    <li>2. Level-2 from MHCA</li>
                                    <li>2. Level-1 from MHCA</li>
                                </ul>
                                </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-9 col-sm-12">
                        <div className="cardBlur mt-5 p-3">
                            ...
                            <br />
                            <br />
                            He Leads the Nandurbar District Cricket Association in MCA's Initational League 2017-21. Jangid is deeply involved in the game for the past 10 years. He has played in Cooch Behar Trophy for Maharashtra Under-19.
                            </p>
                        </div>
                    </div>
                </div>
